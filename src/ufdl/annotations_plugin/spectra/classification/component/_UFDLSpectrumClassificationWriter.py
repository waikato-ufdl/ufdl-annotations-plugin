...
class UFDLSpectrumClassificationWriter(UFDLWriter[SpectrumClassificationInstance]):
    """
    ...
    def write_to_dataset(self, element: SpectrumClassificationInstance, dataset_pk: int, subfolder: Optional[str]):
