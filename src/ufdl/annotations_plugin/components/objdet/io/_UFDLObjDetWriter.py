...
class UFDLObjDetWriter(UFDLWriter[UFDLObjDetExternalFormat]):
    """
    ...
    def write_to_dataset(self, instances: Iterable[UFDLObjDetExternalFormat], dataset_pk: int, subfolder: Optional[str]):
        ...
        for instance in instances:
            ...
            dataset.set_annotations_for_image(self.ufdl_context, dataset_pk, filename, instance.annotations)

    def extract_file_info_from_external_format(self, instance: UFDLObjDetExternalFormat) -> FileInfo:
